...
const { names = "Nazar", ages = 17, hobbys = "programming", premium = false, ...rest}  = user;
...
console.log(keys);
console.log(user);
console.log(names, ages, hobbys, premium, rest);
for (let i of keys) {
...
const { name = "Nazar", age = 17, hobby = "programming", }  = users;
...
// console.log(getAllPropValues(productss, "name"));
// console.log(getAllPropValues(productss, "price"));
// console.log(getAllPropValues(productss, "quantity"));
